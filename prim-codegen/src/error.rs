...
pub enum CodegenError {
    ...
    UndefinedLocal(prim_compiler::hir::SymbolId),
    ArityMismatch {
        expected: usize,
        found: usize,
    },
    ...
    MissingStructLayout(prim_compiler::hir::StructId),
    MissingStructField {
        struct_id: prim_compiler::hir::StructId,
        field: prim_compiler::hir::InternSymbol,
    },
    MissingStructValue {
        struct_id: prim_compiler::hir::StructId,
        field: prim_compiler::hir::InternSymbol,
    },
    MissingFunction(prim_compiler::hir::FuncId),
    InvalidFieldAccess,
    InvalidDereference,
    InvalidBreak,
    ReturnArityMismatch {
